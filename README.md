...
Heigo 是一个基于 Vue 3 和 Cloudflare Durable Object 的实时多人房间游戏平台。目前支持 UNO 房间对战，包含房间创建、玩家加入、聊天、准备和游戏操作。
...
当前版本聚焦于 UNO 房间玩法，后续可以扩展更多游戏类型、房间规则和匹配机制。